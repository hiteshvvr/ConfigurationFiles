...
#############DAQ 2020 DEFINITIONS#################
export PATH=${PATH%:/home/neatdaq/NeatDAQ2020/packages/midas/bin}
export MIDASSYS=$HOME/NeatDAQ2020/packages/midas
export PATH=$PATH:$MIDASSYS/bin
export ROOTANASYS=$HOME/NeatDAQ2020/packages/rootana
export JSROOTSYS=$HOME/NeatDAQ2020/packages/jsroot
export MIDAS_EXPT_NAME=neontrap
export MIDAS_EXPTAB=$HOME/NeatDAQ2020/online/exptab
#
...
export JAVA_HOME=/opt/jre/jre1.8.0_151
...
# source /opt/root/bin/thisroot.sh
source ~/userbin/root622/bin/thisroot.sh
